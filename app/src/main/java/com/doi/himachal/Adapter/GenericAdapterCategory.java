 ...
 * @Time 01, 05 , 2020
 */
public class GenericAdapterCategory extends ArrayAdapter<CategoryPojo> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<CategoryPojo> values;

    public GenericAdapterCategory(Context context, int textViewResourceId, List<CategoryPojo> values) {
