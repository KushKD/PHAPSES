 ...
 * @Time 05, 05 , 2020
 */
public class GenericAdapterGP extends ArrayAdapter<GramPanchayatPojo> {
// Your sent context
private Context context;
// Your custom values for the spinner (User)
private List<GramPanchayatPojo> values;

public GenericAdapterGP(Context context, int textViewResourceId, List<GramPanchayatPojo> values) {
...
public GramPanchayatPojo getItem(int position) {
