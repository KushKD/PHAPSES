 ...
 * @Time 05, 05 , 2020
 */
public class GenericAdapterStates extends ArrayAdapter<StatePojo> {
// Your sent context
private Context context;
// Your custom values for the spinner (User)
private List<StatePojo> values;

public GenericAdapterStates(Context context, int textViewResourceId, List<StatePojo> values) {
...
public StatePojo getItem(int position) {
