 ...
 * @Time 01, 05 , 2020
 */
public class GenericAdapterSubCategory extends ArrayAdapter<SubCategoryPojo> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<SubCategoryPojo> values;

    public GenericAdapterSubCategory(Context context, int textViewResourceId, List<SubCategoryPojo> values) {
    ...
    public SubCategoryPojo getItem(int position) {
