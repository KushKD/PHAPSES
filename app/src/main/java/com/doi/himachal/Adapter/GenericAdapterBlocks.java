 ...
 * @Time 05, 05 , 2020
 */
public class GenericAdapterBlocks extends ArrayAdapter<BlockPojo> {
// Your sent context
private Context context;
// Your custom values for the spinner (User)
private List<BlockPojo> values;

public GenericAdapterBlocks(Context context, int textViewResourceId, List<BlockPojo> values) {
...
public BlockPojo getItem(int position) {
